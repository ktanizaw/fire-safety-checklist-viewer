...
export type AssessmentCardFragment = {
  __typename: 'Assessment';
  id: string;
  buildingName: string;
  address: string;
...
} & { ' $fragmentName'?: 'AssessmentCardFragment' };

export type AssessmentInfoFragment = {
  __typename: 'Assessment';
  id: string;
  buildingName: string;
  address: string;
...
} & { ' $fragmentName'?: 'AssessmentInfoFragment' };
...
export type AssessmentQuestionFragment = {
  ...
  notes?: string | null;
} & { ' $fragmentName'?: 'AssessmentQuestionFragment' };

export type AssessmentSectionAccordionFragment = {
  __typename: 'AssessmentSection';
  id: string;
  title: string;
  description: string;
...
export type AssessmentDetailQuery = {
  __typename: 'Query';
  assessmentById: {
    __typename: 'Assessment';
    id: string;
    sections: Array<
      {
        ...
        ' $fragmentRefs'?: {
          AssessmentSectionAccordionFragment: AssessmentSectionAccordionFragment;
        };
      }
    >;
...
export type AssessmentIndexQuery = {
  __typename: 'Query';
  assessments: Array<
    {
      __typename: 'Assessment';
...
export const AssessmentCardFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'buildingName' } },
...
} as unknown as DocumentNode<AssessmentCardFragment, unknown>;
export const AssessmentInfoFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'AssessmentInfo' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'Assessment' },
      },
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'lastUpdated' } },
          { kind: 'Field', name: { kind: 'Name', value: 'responsiblePerson' } },
          { kind: 'Field', name: { kind: 'Name', value: 'assessor' } },
          { kind: 'Field', name: { kind: 'Name', value: 'dateOfAssessment' } },
          { kind: 'Field', name: { kind: 'Name', value: 'useOfPremises' } },
          { kind: 'Field', name: { kind: 'Name', value: 'numberOfFloors' } },
          { kind: 'Field', name: { kind: 'Name', value: 'construction' } },
          { kind: 'Field', name: { kind: 'Name', value: 'maxOccupancy' } },
          { kind: 'Field', name: { kind: 'Name', value: 'nextReviewDate' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<AssessmentInfoFragment, unknown>;
export const AssessmentQuestionFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'AssessmentQuestion' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'AssessmentItem' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
} as unknown as DocumentNode<AssessmentQuestionFragment, unknown>;
export const AssessmentSectionAccordionFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'AssessmentSectionAccordion' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'AssessmentSection' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'completionPercentage' },
          },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'pendingActionCount' },
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'assessmentDetail' },
      variableDefinitions: [
        {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                      {
                        ...
                        name: {
                          kind: 'Name',
                          value: 'AssessmentSectionAccordion',
                        },
                      },
                      {
                        kind: 'Field',
...
export const AssessmentIndexDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'assessmentIndex' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'AssessmentFilter' },
          },
        },
        {
          kind: 'VariableDefinition',
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'AssessmentSort' },
          },
        },
      ],
      selectionSet: {
  ...
  AssessmentIndexQuery,
  AssessmentIndexQueryVariables
>;
