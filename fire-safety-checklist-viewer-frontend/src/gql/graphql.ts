...
export type AssessmentSectionFragment = { __typename: 'AssessmentSection', id: string, title: string, description: string, order: number, completionPercentage: number, pendingActionCount?: number | null } & { ' $fragmentName'?: 'AssessmentSectionFragment' };
...
export type AssessmentDetailQuery = { __typename: 'Query', assessmentById: (
    { __typename: 'Assessment', id: string, sections: Array<(
      ...
      & { ' $fragmentRefs'?: { 'AssessmentSectionFragment': AssessmentSectionFragment } }
    )> }
